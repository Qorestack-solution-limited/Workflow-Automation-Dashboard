...
const ComplianceRow = ({ id, policy, status, lastCheck, auditor }: any) => {
  ...
  return (
    <tr className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
      <td className="py-4 px-6 text-sm font-medium text-gray-900">#{id}</td>
      <td className="py-4 px-6 text-sm text-gray-700">{policy}</td>
      ...
      <td className="py-4 px-6 text-sm text-gray-500">{lastCheck}</td>
      <td className="py-4 px-6 text-sm text-gray-500">{auditor}</td>
    ...
    <div className="p-8 h-full overflow-y-auto bg-gray-50/50">
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-gray-500">Monitor system adherence to policies</p>
        </div>
        <div className="flex gap-3">
            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 text-sm font-medium">
                <Filter size={16} />
                Filter
            </button>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <table className="w-full">
          <thead className="bg-gray-50/50">
            <tr>
              <th className="py-3 px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">ID</th>
              <th className="py-3 px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Policy Name</th>
              <th className="py-3 px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
              <th className="py-3 px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Last Check</th>
              <th className="py-3 px-6 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Auditor</th>
